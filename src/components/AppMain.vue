<template>
  <main>
    <section>
     ...
     <div class="row">
         <firstCardMain v-for="card in cards" 
         :key=card.id
         :card="card"
         />
        </div>   
...
components:{
  ...
  data() {
    return {
        ...
        cards: [
        { id: 1, title: "same day appointments", content: "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium ", image: "/img/icon-1.png" },
